...
/// @dev It answers the five getters a receiver reads at initialization, so a receiver can be bound
...
contract HostileSplitter {
    ...
    constructor(address treasury_, address recoveryAdmin_, address usdc_, address regent_, address subject_) {
        treasury = treasury_;
