...
Launch fee split & 1\% to Regents Labs, 1\% to the agent Safe in the auction quote token \\
CCA raise fee & 2\% of the auction quote token raised in the continuous clearing auction \\
Agent \USDC{} rule & Base \USDC{} counts only after it reaches the agent-owned revsplit; verified ingress and direct deposits are tracked separately \\
