...
export const CROWN_FRAME_MARGIN = 0.1
 ...
 * offset composes the crown slightly into the upper-right of its island without
...
/** Parks the crown in the small upper-right island, filling that canvas. */
export function crownFrameOffsetNdc(
  _aspect: number,
  _centeredViewProjection?: Float32Array,
