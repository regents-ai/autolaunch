defmodule Autolaunch.LaunchRpcClientTest do
  @moduledoc """
  ...
  alias Autolaunch.{LaunchChainClient, LaunchRpcClient}
  ...
  describe "PRODUCTION_STAYS_FAIL_CLOSED: the release default prepares nothing" do
    test "the release default is the client, with no test override installed" do
      refute Application.get_env(:autolaunch, :autolaunch_launch_chain_client)
