defmodule Autolaunch.Stocks.LaunchDraftImage.Changes.PrepareImmutableImage do
  @moduledoc false
  ...
  def change(changeset, _opts, %{actor: %Human{} = actor}) do
    ...
    draft_id = Ash.Changeset.get_attribute(changeset, :stock_launch_draft_id)
