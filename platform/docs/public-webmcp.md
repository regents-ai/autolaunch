...
in their existing date order. Mode and sort apply within both groups. A configured
chain read failure returns an error instead of a partial page. Cursors expire after
