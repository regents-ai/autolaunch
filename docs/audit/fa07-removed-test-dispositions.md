...
Inventory authority: the test diff from `4beace7b788da039102651844a7d18a300d97201` through
`3634f6f0e11523c426662b7524f2c94fd37d3597`. The 22 removed selectors below are accounted for
exactly once. These rows track test accountability only; production ABI and removed-surface claims
remain static ABI/source evidence.
